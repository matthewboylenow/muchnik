    ...
    <div>
      ...
      <section className="relative bg-navy text-white overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/images/practice-areas/business-planning.jpg"
        ...
        <div className="relative container-custom py-20 md:py-28">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-gray-100 font-semibold">
              Assisting clients in formation, purchase, or sale of a business
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <p className="text-xl text-charcoal leading-relaxed mb-6">
                Assisting clients in the formation, purchase or sale of a business; business consulting and preparation of shareholder and partnership agreements; providing for the smooth transfer of a business.
              </p>
            </div>
            ...
            <div className="mt-12 bg-gradient-to-br from-navy to-navy-light text-white rounded-xl p-8 md:p-12">
              ...
              <ul className="space-y-3 text-lg">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>Purchase and sale agreements</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-gold mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span>Shareholder and partnership agreements</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-gold mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <div className="mt-12 bg-white rounded-xl p-8 md:p-12 shadow-lg border-t-4 border-gold">
              ...
              <p className="text-lg text-charcoal mb-6">
                Contact us to discuss your business planning and succession needs.
              </p>
              <Link href="/contact">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <Link href="/practice-areas/estate-planning" className="group">
              <div className="bg-cream rounded-lg p-6 h-full hover:shadow-lg transition-shadow">
                ...
                <p className="text-charcoal">
                  Plan for business succession and family transfers.
                </p>
              </div>
            </Link>
            <Link href="/practice-areas/tax-law" className="group">
              <div className="bg-cream rounded-lg p-6 h-full hover:shadow-lg transition-shadow">
                ...
                <p className="text-charcoal">
                  Minimize tax implications of business transactions.
                </p>
              </div>
            </Link>

...
export const practiceAreas: PracticeArea[] = [
  {
    ...
    shortDescription: 'Safeguarding a lifetime of savings from long-term care costs',
    fullDescription: `Elder Law & Asset Protection focuses on safeguarding a lifetime of savings from the high costs of long-term care, including nursing homes, home care, and assisted living.
...
Beyond asset protection, our attorneys also guide clients through essential planning tools such as powers of attorney, health care proxies, advance directives, and family care agreements. With offices in both New York and New Jersey, we understand the specific rules, look-back periods, and planning opportunities unique to each state. We bring that knowledge and experience to every matter we handle, helping you protect what you have worked so hard to build and providing you and your family with clarity, security, and peace of mind about the future.`,
  ...
  },
  {
    ...
    shortDescription: 'Expert guidance through the Medicaid eligibility process',
    fullDescription: `As a Firm, we are committed to making the Medicaid eligibility application process easy to grasp, so that individuals and families understand how their existing health care benefits work, helping them to gain the greatest possible benefits from their existing medical insurance and receive all of the medical benefits to which they are entitled.
...
Whether an estate is straightforward or involves multiple properties, businesses, or cross-border assets, we provide efficient, organized, and transparent administration. We work to minimize delays and disputes. We keep executors, administrators, trustees and Attorneys-in-Fact informed about the full range of their fiduciary responsibilities to help them avoid personal liability while honoring the decedent's wishes.`,
  ...
  },
  {
    ...
    shortDescription: 'Protecting your rights in contested estate matters',
    fullDescription: `Disputes involving a loved one's estate can be emotionally charged and financially significant. Our attorneys represent beneficiaries, executors, administrators, trustees, and family members in contested matters. We handle will contests, trust disputes, claims of undue influence or incapacity, accounting proceedings, and breach of fiduciary duty cases.
...
We also coordinate special needs planning with your broader estate plan to protect siblings and other beneficiaries and address who will manage funds and care decisions in the future. Our attorneys help you consider guardianship, supported decision-making, and transition planning so your loved one is supported both financially and personally over a lifetime.`,
  ...
  },
  {
    ...
    fullDescription: `When an adult or child cannot manage their personal or financial affairs, a guardianship may be necessary to protect them.

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <a
                href="https://www.facebook.com/MuchnikElderLaw/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/MuchnikElderLaw/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/company/johnson-langworthy-muchnik-p-c/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="text-gray-300 hover:text-gold transition-colors"
